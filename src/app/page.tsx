...
import metersToKelometrs from "@/utils/metersToKelometrs";
...
// https://api.openweathermap.org/data/2.5/forecast?q=pune&appid=d5d2a6afbbd70dec15159104f3bea2fe&cnt=56
...
export default function Home() {
  ...
  console.log(data?.city.country,"dataaaa");
  console.log(data,"d")
      ...
      <main className="px-3 max-w-7xl mx-auto flex flex-col gap-9 w-full pb-10 pt-4">
        ...
        <section className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <Container className="bg-yellow-300/80 px-6 gap-4 justify-between overflow-x-auto">
              <WeatherDetails visibilty={metersToKelometrs(firstData?.visibility ?? 10000)}
        ...
        <section className="flex w-full flex-col gap-4">
                ...
                {firstDataForEachDate.map((d,i)=> (
                  ...
                  visibilty={`${metersToKelometrs(d?.visibility ?? 10000)}`}
